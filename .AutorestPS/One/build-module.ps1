...
$dll = Join-Path $PSScriptRoot 'bin\OneFunctionApi.private.dll'
...
$modulePaths = $dll
$customPsm1 = Join-Path $PSScriptRoot 'custom\OneFunctionApi.custom.psm1'
...
$psd1 = Join-Path $PSScriptRoot './OneFunctionApi.psd1'
$guid = Get-ModuleGuid -Psd1Path $psd1
$moduleName = 'OneFunctionApi'
...
$formatPs1xml = Join-Path $PSScriptRoot './OneFunctionApi.format.ps1xml'
