...
namespace OneFunction.Runtime.PowerShell
{
    ...
    public class AsyncOperationResponse
    {
        ...
        internal AsyncOperationResponse(OneFunction.Runtime.Json.JsonObject json)
        {
            // pull target 
            { Target = If(json?.PropertyT<OneFunction.Runtime.Json.JsonString>("target"), out var _v) ? (string)_v : (string)Target; }
        }
        ...
        public static AsyncOperationResponse FromJson(OneFunction.Runtime.Json.JsonNode node)
        {
            return node is OneFunction.Runtime.Json.JsonObject json ? new AsyncOperationResponse(json) : null;
        }
        ...
        public static AsyncOperationResponse FromJsonString(string jsonText) => FromJson(OneFunction.Runtime.Json.JsonNode.Parse(jsonText));
    ...
    public partial class AsyncOperationResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static bool CanConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ...
                return true == text?.StartsWith("{") && true == text?.EndsWith("}") && OneFunction.Runtime.Json.JsonNode.Parse(text).Type == OneFunction.Runtime.Json.JsonType.Object;
            }
            catch
            {
