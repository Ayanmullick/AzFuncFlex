...
using OneFunction.Runtime.Json;
using System;
...
namespace OneFunction.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is OneFunction.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return OneFunction.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return OneFunction.Runtime.JsonSerializable.ToJson(dict, null);
            }
