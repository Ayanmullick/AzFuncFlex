...
namespace OneFunction
{
    ...
    public partial class Module
    {
        ...
        private static OneFunction.Module _instance;

        /// <summary>the ISendAsync pipeline instance</summary>
        private OneFunction.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private OneFunction.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public OneFunction.OneFunctionApi ClientAPI { get; set; }
        ...
        public static OneFunction.Module Instance { get { if (_instance == null) { lock (_singletonLock) { if (_instance == null) { _instance = new Module(); }}} return _instance; } }

        /// <summary>The Name of this module</summary>
        public string Name => @"OneFunctionApi";

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref OneFunction.Runtime.HttpPipeline pipeline);

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref OneFunction.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of OneFunction.Runtime.HttpPipeline for the remote call.</returns>
        public OneFunction.Runtime.HttpPipeline CreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, string parameterSetName = null, global::System.Collections.Generic.IDictionary<string,object> extensibleParameters = null)
        {
            OneFunction.Runtime.HttpPipeline pipeline = null;
        ...
        {
            // constructor
            ClientAPI = new OneFunction.OneFunctionApi();
            _handler.Proxy = _webProxy;
            _pipeline = new OneFunction.Runtime.HttpPipeline(new OneFunction.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new OneFunction.Runtime.HttpPipeline(new OneFunction.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
